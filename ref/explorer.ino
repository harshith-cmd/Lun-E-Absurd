...
void drawEyes(float x, float y, bool blink) {
  ...
  display.fillRoundRect(leftX - eyeW / 2 + x, eyeY - eyeH / 2 + y, eyeW, eyeH,
                        10, SSD1306_WHITE);

  display.fillRoundRect(rightX - eyeW / 2 + x, eyeY - eyeH / 2 + y, eyeW, eyeH,
                        10, SSD1306_WHITE);
...
// ================= NEW PEER =================
void onNewPeer(const esp_now_recv_info_t *info, const uint8_t *data, int len,
               void *arg) {
